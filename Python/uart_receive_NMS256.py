...
COM_PORT      = 'COM6'
BAUD_RATE     = 115200
IMAGE_PATH = r"D:\Vedant\NIT\Electronics\Summer_Intern_CSoC\Image\256\chessboard9x9_centered_256.png"  
DISPLAY_SIZE  = 1024
CORNER_RADIUS = 8
IMAGE_SIZE    = 256          # CHANGED: 128 → 256
NMS_RADIUS    = 8
...
SCALE = DISPLAY_SIZE // IMAGE_SIZE    # CHANGED: 1024//256 = 4
...
try:
    while True:
        ...
        if rx_x is not None and rx_y is not None:
            # CHANGED: filter < 256, border 4-251
